...
<head>
  ...
  <meta name="description"
    content="@yield('meta_description', 'Goal Shot Ball Association of Bihar (Reg.No 200/2008). Affiliated with Goal Shot Ball Association of India and recognized by Asian and International Federations.')">
  ...
  <script>
    jQuery(function ($) {
      $('.press-grid').magnificPopup({
        ...
        image: { titleSrc: function (item) { return item.el.attr('aria-label') || ''; } }
      });
      ...
      $('[data-press-toggle]').on('click', function () {
        ...
        if (expanded) {
          $('html, body').animate({ scrollTop: $('#press').offset().top - 80 }, 350);
        }
      });
      ...
      (function () {
        ...
        form.addEventListener('submit', function (e) {
          ...
          form.reset();
          setTimeout(function () { success.hidden = true; close(); }, 1800);
        });
      })();
